...
// CUG
router.get('/CUG/tender', require('./routes/CUG/tender'));

// CMI
router.get('/CMI/tender', require('./routes/CMI/tender'));

// CHT
router.get('/CHT/notice', require('./routes/CHT/notice'));

// ECSMNR
router.get('/ECSMNR/announcement', require('./routes/ECSMNR/announcement'));

// Capacity Media
router.get('/CapacityMedia/news', require('./routes/CapacityMedia/news'));

// MOTCPDB
router.get('/MOTCPDB/notice', require('./routes/MOTCPDB/notice'));
